# FINAL PART 1 - APPLIED SOLUTION SET
...
Part 1 of the final asks you to create small algorithmic solutions, show
...
tradeoffs, limitations, and AI use responsibly.

Part 1 is the work you submit.

Part 2 will ask you to explain the work you submitted.
...
Submit your work through GitHub unless your instructor gives different
instructions.
...
- previous-work reference note, if applicable
- any known issues or improvements

The README is not extra paperwork. It is where you show the reasoning and
evidence behind your code.
...
Use a table like this in your README:
...
At least two of your tests should be edge cases.
...
| Input Size Or Test Set | Direct Comparison Result | Set/Dictionary Result | Same Output? | What Changed? |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |
|  |  |  |  |  |
|  |  |  |  |  |
...
Your explanation should compare the approaches. Do not only say which one
worked.
...
Use a representation table like this:

| Resource | Tags Or Features |
| --- | --- |
|  |  |
|  |  |
|  |  |
...
Use a ranking table like this:

| Rank | Resource | Shared Tags Or Score Evidence | Score | Note |
| --- | --- | --- | --- | --- |
| 1 |  |  |  |  |
| 2 |  |  |  |  |
| 3 |  |  |  |  |
...
Your recommendation should explain why the top result ranked highest and what
...
AI may be used in Part 1 if you use it responsibly and within the boundaries
stated by your instructor.

If you use AI, your README must explain:
...
You may use your own previous course submissions as a reference while
...
submission fits the new task.

Be ready to explain:

- what you reused
- what you changed
- why it fits this final task
- how you verified it
...
Part 2 will ask you to explain your own Part 1 submission.

As you work, make sure you understand:

- what your code does
- why your tests matter
- what assumptions you made
- what tradeoffs you chose
- what limitations remain
- what AI or previous work contributed, if applicable
